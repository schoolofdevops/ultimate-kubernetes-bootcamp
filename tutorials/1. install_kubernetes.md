...
On all nodes which would be part of this cluster, you need to do the base setup as described on [This Page](base-setup.md)
...
There are various overlay networking drivers available for kubernetes. We are going to use **Project Calico**.

```
kubectl apply -f http://docs.projectcalico.org/v2.6/getting-started/kubernetes/installation/hosted/kubeadm/1.6/calico.yaml
